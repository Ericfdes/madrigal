const chat = {
    ...
    1: {
       ...
       options: [{
        text: 'What is Madrigal Corporate Solutions?',
        next: 10
    ...
    13: {
        text: 'You can contact us through <br></br><br> <strong>Email: </strong>  Madrigal.cos@gmail.com </br><br></br> <strong>Phone : </strong> 91-7030222765 \ 91-7796520001 <br></br>',
        options: [
            {
                text: 'What is Madrigal Corporate Solutions?',
                next: 10
