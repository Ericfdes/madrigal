...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'valiantdoge.pythonanywhere.com']
...
AUTHENTICATION_BACKENDS = [
    ...
    'authapp.auth_backend_ep.EmailOrUsernameModelBackend',
    'social_core.backends.linkedin.LinkedinOAuth2',
    # 'authapp.custombackend.ExtractLinkedinOAuth2',
    ]
...
# SOCIAL_AUTH_EXTRACT_LINKEDIN_OAUTH2_PIPELINE = (
#     'social_core.pipeline.social_auth.social_details',
#     'authapp.pipeline.capture_user_data',
# )
...
# EMAIL_USE_TLS = True
# EMAIL_PORT = 587
# EMAIL_HOST_USER = 'aspire.response@gmail.com'
# EMAIL_HOST_PASSWORD = 'jwvohqjagknwaedp' 
